  ...
  <body>
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"> <a href="math.php"> Math </a> </li>
    ...
    <section id="questionbar">
      <div class="container">
        ...
        <form action="php/questionHandler.php" method="post">
			<input name="Subject" type="hidden" value="Math">
    ...
    <section id="text_areas">
		...
		<?php
			...
			$sql = "SELECT * from questions q LEFT JOIN (SELECT message AS answer, user AS ansUser, question_id FROM answers) a ON q.id = a.question_id WHERE subject = 'Math' ORDER BY score DESC";
					  ...
					  <div class="panel">
						...
						if (isset($_SESSION['login_user'])){
							...
							<form action="php/commentHandler.php" method="post" id="form1">
								...
								<input name="Return" type="hidden" value="math.php">
