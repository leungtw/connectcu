  ...
  <body>
    ...
    <section id="text_areas">
		...
		<?php
			...
			$sql = "SELECT * from questions q LEFT JOIN (SELECT message AS answer, user AS ansUser, question_id FROM answers) a ON q.id = a.question_id WHERE subject = 'Computer Science' ORDER BY score DESC";
