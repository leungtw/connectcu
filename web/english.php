...
<html>
  ...
  <head>
    ...
    <title>CUConnect | English</title>
    <link rel="stylesheet" href="./css/English_style.css">
  ...
  <body>
    ...
    <section id="text_areas">
		...
		<?php
			...
			$sql = "SELECT * from questions q LEFT JOIN (SELECT message AS answer, user AS ansUser, question_id FROM answers) a ON q.id = a.question_id WHERE subject = 'English' ORDER BY score DESC";
